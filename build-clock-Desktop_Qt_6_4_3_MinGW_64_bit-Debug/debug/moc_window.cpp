...
Q_CONSTINIT static const qt_meta_stringdata_Window_t qt_meta_stringdata_Window = {
    {
        ...
        QT_MOC_LITERAL(7, 11),  // "timeChanged"
        QT_MOC_LITERAL(19, 0),  // ""
        QT_MOC_LITERAL(20, 1),  // "s"
        QT_MOC_LITERAL(22, 6)   // "update"
    },
    "Window",
    "timeChanged",
    "",
...
void Window::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Window::timeChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void Window::timeChanged(const QString & _t1)
{
